...
const prepColors = input => {
  const base = (input && input.length ? input : ['#FF8F68', '#FF3D00', '#FF5E3A', '#E02E00']).slice(0, MAX_COLORS);
...
const Lightfall = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (mouseInteraction && onPointerMove) window.removeEventListener('pointermove', onPointerMove);
      if (ro) ro.disconnect();
